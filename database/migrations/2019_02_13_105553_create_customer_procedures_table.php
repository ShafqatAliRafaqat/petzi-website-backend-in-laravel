...
class CreateCustomerProceduresTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('customer_procedures', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->increments('id');
        ...
        Schema::table('customer_procedures', function($table){
    ...
    {
        Schema::dropIfExists('customer_procedures');
    }
}

...
class CreateCustomerDiagnosticsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('customer_diagnostics', function (Blueprint $table) {
            $table->increments('id');
        ...
        Schema::table('customer_diagnostics', function($table){
    ...
    {
        Schema::dropIfExists('customer_diagnostics');
    }
}

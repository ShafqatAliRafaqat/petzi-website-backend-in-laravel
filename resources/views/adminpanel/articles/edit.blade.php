            ...
            <form class="form-horizontal" method="post" action="{{ route('articles.update', $article->id) }}"
              enctype="multipart/form-data">
                ...
                <div class="form-group row">
                  <label class="col-md-3 form-control-label">Select treatment</label>
                  <div class="col-md-9">
                    <select name="treatment_id" id="" class="form-control {{ $errors->has('treatment_id') ? 'is-invalid' : '' }}">
                      <option value="">Select treatment</option>
                      @foreach($treatments as $treatment)
                      <option value="{{ $treatment->id }}"
                        {{ ($article->treatment_id == $treatment->id) ? 'selected' : '' }}>
                        {{ $treatment->name }}
                      </option>
                      @endforeach
                    </select>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                        ...
                        class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" value="{{ $article->title }}" required>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-3">
                    <img src="{{ asset('backend/uploads/articles/'.$article->picture) }}" class="img-fluid" alt="{{ $errors->first('picture') }}" height="100" width="100">
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                        ...
                        class="form-control {{ $errors->has('category') ? 'is-invalid' : '' }}" value="{{ $article->category }}" required>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                      <textarea placeholder="Enter Details" class="form-control tiny" name="article" id="" cols="30" rows="10">{!! $article->article !!}</textarea>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                      <input type="text" name="meta_title" placeholder="SEO Meta Title" value="{{ $article->meta_title }}"
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                      <input type="text" name="meta_description" placeholder="SEO Meta Description" value="{{ $article->meta_description }}"
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                      <input type="text" name="url" placeholder="Enter URL" value="{{ $article->url }}"
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    <div class="custom-control custom-checkbox">
                      <input id="is_active" value="1" type="checkbox" name="is_active" class="custom-control-input" {{ $article->is_active == 1 ? 'checked':'' }}>

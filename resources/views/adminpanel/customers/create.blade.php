...
@section('title','Create Customer | HospitALL')
@section('styles')
    ...
    <div class="row">
      ...
      <div class="col-lg-12 mb-5">
        <div class="card">
          ...
          <div class="card-body">
            <form class="form-horizontal" method="post" id="customer-form" action="{{ route('customers.store') }}" enctype="multipart/form-data">
            @csrf
            ...
            <input type="radio" onclick="javascript:yesnoCheck();" name="yesno" id="noCheck" checked="checked">
               ...
               <div class="col-md-4 offset-md-2" id="ifYes" style="visibility:hidden">
                ...
                <div class="form-group row">
                        ...
                        <div class="col-md-4">
                              <input type="date" name="next_contact_date" placeholder="next_contact_date" min='<?php echo date('Y-m-d');?>'

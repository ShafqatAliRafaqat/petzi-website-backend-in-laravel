    ...
    <div class="row">
      ...
      <div class="col-lg-12 mb-5">
        <div class="card">
          ...
          <div class="card-body">
            <form class="form-horizontal" method="post" id="customer-form" action="{{ route('customers.update', $customer->id) }}" enctype="multipart/form-data">
                @csrf @method('put')
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-4">
                    <select name="status_id" id="" class="form-control">
                      ...
                      @foreach($status as $s)
                        <option value="{{ $s->id }}" {{ $customer_status->id == $s->id ? 'selected': '' }}>{{ $s->name }}</option>
                      @endforeach
                    </select>

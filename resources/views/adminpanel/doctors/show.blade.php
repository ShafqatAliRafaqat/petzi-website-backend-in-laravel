      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="profile-head">
            ...
            <p class="proile-rating">VIEWS : <span>{{$doctor_views}}</span></p>
        ...
        <div class="col-md-2">
          <a href="{{ route('doctors.edit', $doctor->id) }}" class="profile-edit-btn a-doctor-btn" >
            Edit Doctor
          </a>
        </div>
      </div>
      <div class="row">
        <div class="col-md-4">
          <div class="profile-work">
            ...
            <a >{{$doctor->name}}</a><br/>
            <a >{{$doctor->last_name}}</a><br/>
            <a >{{$doctor->pmdc}}</a><br/>
            @php
            if(isset($doctor->experience)){
            $experience     =   YearsDiff($doctor->experience).' of Experience';
          } else {
          $experience     = Null;
        }
        @endphp
        ...
        <a >{{$doctor->assistant_name}}</a><br/>
        <a >{{$doctor->assistant_phone}}</a><br/>
    ...
    <div class="col-md-8">
      <div class="tab-content profile-tab" id="myTabContent">
        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
          ...
          @php
          $created_by_id = Auth::user()->find($doctor->created_by);
          $updated_by_id = Auth::user()->find($doctor->updated_by);
          $deleted_by_id = Auth::user()->find($doctor->deleted_by);
          @endphp
          <div class="row">
            <div class="col-md-6 offset-6 text-right" style="color: grey">
          ...
          <div class="card-body">
            <div class="media row">
              <div class="media-body col-md-12">
                <table class="table table-striped table-dark" id="treatments1">
                  <thead>
                    <tr>
                      <th scope="col">#</th>

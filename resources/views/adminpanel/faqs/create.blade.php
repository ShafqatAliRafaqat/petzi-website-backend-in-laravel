      ...
      <div class="col-lg-12 mb-5">
        <div class="card">
          <div class="card-header">
            <h3 class="h6 text-uppercase mb-0">Create Faq's</h3>
          </div>
          <div class="card-body">
            <form class="form-horizontal" method="post" action="{{ route('faqs.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="form-group row">
                  <div class="col-md-3 form-control-label">Select Treatments</div>
                  <div class="col-md-9">
                    <select name="treatment_id" id="" class="form-control">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                        <input type="text" name="title" placeholder="Faq Question"
                ...
                <div class="form-group row">
                  <label class="col-md-3 form-control-label">Anwser</label>
                  <div class="col-md-9">
                      <textarea placeholder="Enter Details" class="form-control tiny" name="article" id="" cols="30" rows="10">{{ old('description') }}</textarea>

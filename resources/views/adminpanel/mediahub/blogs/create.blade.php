        ...
        <div class="card">
          ...
          <div class="card-body">
            <form class="form-horizontal" method="post" action="{{ route('blogs.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                  <label class="col-md-3 form-control-label">Picture <span class="asterisk">*</span></label>
                  <div class="col-md-9">
                    <span class="btn btn-success fileinput-button">
                        <span>Select Attachment</span>
                        <input type="file" name="picture[]" multiple id="files" class="form-control {{ $errors->has('picture') ? 'is-invalid' : '' }}" required><br />
                    </span>

      ...
      <div class="col-lg-12 mb-5">
        <div class="card">
          <div class="card-header">
            <h3 class="h6 text-uppercase mb-0">Edit Video</h3>
          </div>
          <div class="card-body">
            <form class="form-horizontal" method="post" action="{{ route('media.update',$media->id) }}" enctype="multipart/form-data">
                @csrf @method('put')
                <div class="form-group row">
                  <label class="col-md-3 form-control-label">Title <span class="asterisk">*</span></label>
                  <div class="col-md-9">
                        <input type="text" name="title" placeholder="Video Title"
                        class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" value="{{ $media->title }}" required>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                        ...
                        class="form-control {{ $errors->has('link') ? 'is-invalid' : '' }}" value="{{ $media->link }}" required>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                      <textarea placeholder="Enter Details" class="form-control tiny" name="description" id="" cols="30" rows="10" >{{ $media->description }}</textarea>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                      ...
                      class="form-control {{ $errors->has('meta_title') ? 'is-invalid' : '' }}" value="{{ $media->meta_title }}">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                      ...
                      class="form-control {{ $errors->has('meta_description') ? 'is-invalid' : '' }}" value="{{ $media->meta_description }}">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                      ...
                      class="form-control {{ $errors->has('url') ? 'is-invalid' : '' }}" value="{{ $media->url }}">
                    @if($errors->has('url'))
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    <div class="custom-control custom-checkbox">
                      <input id="is_active" value="1" type="checkbox" {{($media->is_active == 1)? 'checked':''}} name="is_active" class="custom-control-input">
                      <label for="is_active" class="custom-control-label">Check to Active the Media</label>
                    </div>
                  </div>
                </div>
                <div class="form-group row">
                    <label class="col-md-3 form-control-label">Position At Page</label>
                        <div class="col-md-2">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input id="bottom" type="radio" value="0" name="position" class="custom-control-input" {{ $media->position == 0 ? 'checked':'' }}>
                                    <label for="bottom" class="custom-control-label">Bottom</label>
                                  </div>
                                </div>
                                <div class="col-md-2">
                                  <div class="custom-control custom-radio custom-control-inline">
                                    <input id="center" type="radio" value="1" name="position" class="custom-control-input" {{ $media->position == 1 ? 'checked':'' }}>
                                    <label for="center" class="custom-control-label">Center</label>
                                  </div>
                                </div>
                                <div class="col-md-2">
                                  <div class="custom-control custom-radio custom-control-inline">
                                <input id="top" type="radio" value="2" name="position" class="custom-control-input" {{ $media->position == 2 ? 'checked':'' }}>
                ...
                <div class="form-group row">
                  <div class="col-md-9 ml-auto">
                    <button type="submit" class="btn btn-primary">Update Vedio</button>
                  </div>
                </div>
            </form>
          </div>

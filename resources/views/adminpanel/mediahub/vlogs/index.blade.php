            ...
            <div class="col-lg-12">
                <div class="card">
                  <div class="card-header">
                    <h6 class="text-uppercase mb-0">Vlogs <a href="{{ route('vlogs.create') }}" class="btn btn-sm btn-dark float-right">Create New</a></h6>
                  </div>
                  <div class="card-body table-responsive">
                    <table class="table table-striped table-sm card-text" id="vlogs">
                      <thead>
                        <tr>
                          <th>#</th>
                          <th>Title</th>
                      ...
                      <tbody>
                        @if($vlogs)
                            ...
                            <tr>
                              ...
                              <td><a href="{{ route('vlogs.edit', $data->id) }}"><i class="fa fa-edit"></i></a></td>
                              <td>
                                <a class="delete" data-id="{{ $data->id }}" href="#"><i class="fa fa-trash"></i></a>
                                <form id="deleteForm{{$data->id}}" method="post" action="{{ route('vlogs.destroy', $data->id) }}">
                                    @csrf @method('delete')
                                </form>
                              </td>
                            </tr>

      ...
      <div class="col-lg-12 mb-5">
        <div class="card">
          <div class="card-header">
            <h3 class="h6 text-uppercase mb-0">Edit Status</h3>
          </div>
          <div class="card-body">
            <form class="form-horizontal" method="post" action="{{ route('status.update', $status->id) }}" enctype="multipart/form-data">
                @csrf @method('put')

                <div class="form-group row">
                  <label class="col-md-2 form-control-label">Status Name</label>
                  <div class="col-md-9">
                        <input type="text" name="name" value="{{ $status->name }}" placeholder="Status name"
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    <div class="custom-control custom-checkbox">
                      <input id="is_active" {{ $status->active == 1 ? 'checked' : '' }} value="1" type="checkbox" name="active" class="custom-control-input">

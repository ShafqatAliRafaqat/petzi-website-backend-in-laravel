...
<html ⚡>
  <head>
    ...
    <link rel="canonical" href="http://hospitallcare.com/blogs/{{$article->id}}/{{str_slug($article->title,'-')}}" />
  ...
  <body>
    ...
    <amp-img width="360" height="200" alt="{{ $article->title }}" src="{{ asset('backend/uploads/articles/'.$article->picture) }}"></amp-img>
    <p>
      {!! $article->article !!}
    </p>
    </article>

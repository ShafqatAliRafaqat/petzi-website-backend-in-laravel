...
<html ⚡>
  <head>
    ...
    <link rel="canonical" href="http://hospitallcare.com/" />
  ...
  <body>
    ...
    <amp-carousel id="slider" width="500" height="200" layout="responsive" type="slides" autoplay delay="5000">
      <amp-img src="{{ asset('inc/images/home/banner-1.png') }}" width="400" height="300" layout="responsive"
        alt="HospitALL Slider Image 1"></amp-img>
      <amp-img src="{{ asset('inc/images/home/banner-2.png') }}" width="400" height="300" layout="responsive"
        alt="HospitALL Slider Image 2"></amp-img>
      <amp-img src="{{ asset('inc/images/home/banner-3.png') }}" width="400" height="300" layout="responsive"
        alt="HospitALL Slider Image 3"></amp-img>
    </amp-carousel>
    <article>
      <h1>Welcome To HospitALL</h1>
      <p class="drop-caps">We are drivers of innovation who aim to transform the future of healthcare in Pakistan. We are problem solvers, we are solutions providers, we are teachers and we are leaders. We understand the complex ecosystem of healthcare in developing Pakistan and have a team of seasoned professionals who will lead the charge and create a healthcare system which is beneficial for all players in the game. HospitALL is the future of healthcare. Creating an atmosphere of care, cure and support.</p>
      <h2 class="text-center">Procedures</h2>
      <amp-selector role="tablist" layout="container" class="ampTabContainer">
        @php $no = 1; @endphp
        @foreach($treatments as $t)
          <div role="tab" class="tabButton" {{ $no == 1 ? 'selected' : '' }} option="a">{{$t->name}}</div>
          <div role="tabpanel" class="tabContent">
            <amp-img src="{{ asset('backend/uploads/treatments/'.$t->picture) }}" width="300" height="150" layout="responsive"
              alt="{{$t->name}}"></amp-img>
            {!! str_limit($t->article,500) !!}
          </div>
          @php $no++ @endphp
        @endforeach
      </amp-selector>
    ...
    <ul>
      ...
      <li><amp-img width="360" height="200" alt="{{ $article->title }}" src="{{ asset('backend/uploads/articles/540x370-'.$article->picture) }}"></amp-img>
        <amp-fit-text width="1000" height="200" layout="responsive"><a href="/amp/blogs/{{ $article->id }}/{{ str_slug($article->title,'-') }}">{{ $article->title }}</a></amp-fit-text></li>
      @endforeach
    </ul>

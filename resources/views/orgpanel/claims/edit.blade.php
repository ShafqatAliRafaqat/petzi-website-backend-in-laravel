            ...
            <div class="col-lg-12">
              ...
              <div class="row">
                <div class="col-lg-4">
                  <h5>Claim Details
                    @if($type == 'custom')
                    <span class="float-right" style="color: #b51212;font-size: 15px;">Not Verified</span>
                    @else
                    <span class="float-right" style="color: #006da0;font-size: 15px;">Verified</span>
                    @endif
                  </h5>
                </div>
                <div class="col-lg-8 tab-profile">
                    <nav>
                      <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                        ...
                        <a class="nav-item nav-link" id="nav-action-tab" data-toggle="tab" href="#nav-action" role="tab" aria-controls="nav-action" aria-selected="false">Action</a>
                      </div>
                    </nav>
                        ...
                        <div class="claim-details">
                          <ul class="list-inline claim-ul">
                            ...
                            <li><div class="row mt-4">
                              ...
                              <div class="col-md-8"><span class="claim-text-span">@php if($patient->claim_status == 0){ echo "Pending"; } elseif($patient->claim_status == 3) { echo "In Progress"; }  @endphp</span></div></div>
                            </li>
                          </ul>
                        </div>
                      </div>
                        ...
                        <form method="POST" action="{{ route('update_claim', $patient->claim_id) }}" enctype="multipart/form-data">
                          ...
                          <div class="claim-details">
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-6  offset-md-2"><hr></div>
                            </div>
                            <div class="row">
                              <div class="col-md-4"><span class="claim-title-span" >Total Amount</span></div>
                            ...
                            <div class="row mt-4">
                              <div class="col-md-4"><span class="claim-title-span">Action</span> <span class="asterisk">*</span></div>
                              <div class="col-md-8 ">
                                <select class="form-control" name="action" required>
                                  <option value="">Select Option</option>
                                  <option value="0" {{ $patient->claim_status == 0 ? 'selected' : ''  }}>Pending</option>
                                  <option value="1" {{ $patient->claim_status == 1 ? 'selected' : ''  }}>Approve</option>
                                  <option value="2" {{ $patient->claim_status == 2 ? 'selected' : ''  }}>Decline</option>
                                  <option value="3" {{ $patient->claim_status == 3 ? 'selected' : ''  }}>Hold</option>
                                </select>
                              </div>
                            </div>

                            <div class="row mt-2">
                              <div class="col-md-4"><span class="claim-title-span" >Internal Comments/Remarks</span></div>
                              <div class="col-md-8"><textarea name="internal_comment" class="form-control" rows="5">{{ $patient->internal_comment }}</textarea>
                              </div>
                            </div>
                            <div class="row mt-2">
                              <div class="col-md-4"><span class="claim-title-span" >Comment/Remarks</span></div>
                              <div class="col-md-8"><textarea name="comment" class="form-control" rows="5">{{ $patient->claim_comment }}</textarea>
                              </div>
                            </div>
                            <div class="row mt-2">
                              <div class="offset-md-4 col-md-8 text-right"><button type="submit" class="btn btn-primary">Process</button></div>
                            </div>
                            <hr>
                            <h5>Attachments</h5>
                            @if(count($invoices)>0)

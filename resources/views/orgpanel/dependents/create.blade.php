      ...
      <div class="col-lg-12 mb-5">
        <div class="card">
          <div class="card-header">
            <h3 class="h6 text-uppercase mb-0">Create Dependent</h3>
          </div>
          <div class="card-body">
            <form class="form-horizontal" method="post" action="{{ route('dependent.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-4">
                    <select name="relation" class="form-control selectpicker" data-live-search="true" required>
                      <option data-value="" value="" selected>Please Select</option>
                      <option data-value="Parent" value="Parent">Parent</option>
                      <option data-value="Sibling" value="Sibling">Sibling</option>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-2">
                    <div class="custom-control custom-radio custom-control-inline">
                      <input id="male" type="radio" value="1" name="gender" class="custom-control-input" {{ old('name') == 0 ? 'checked':'' }}>
                ...
                <div class="form-group row">
                  <label class="col-md-2 form-control-label">Added By</label>
                  <div class="col-md-10">

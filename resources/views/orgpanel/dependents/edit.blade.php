      ...
      <div class="col-lg-12 mb-5">
        <div class="card">
          <div class="card-header">
            <h3 class="h6 text-uppercase mb-0">Edit Dependent</h3>
          </div>
          <div class="card-body">
               ...
               @method('put') @csrf
                <div class="form-group row">
                  ...
                  <div class="col-md-4">
                        ...
                        class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" value="{{ $dependent->name }}" required>
                  ...
                  <div class="col-md-4">
                    <select name="relation" class="form-control selectpicker" data-live-search="true">
                      <option data-value="" value="">Please Select</option>
                      <option data-value="Parent" value="Parent" {{ ($dependent->relation == 'Parent') ? 'selected' : ''}}>Parent</option>
                      <option data-value="Sibling" value="Sibling"{{ ($dependent->relation == 'Sibling') ? 'selected' : ''}}>Sibling</option>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-4">
                        ...
                        class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" value="{{ $dependent->email }}">
                  ...
                  <div class="col-md-4">
                        ...
                        class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" value="{{ $dependent->phone }}" required>
                ...
                <div class="form-group row">
                  <div class="col-md-4">
                  <input type="hidden" name="parent_id"  placeholder="parent_id"
                        class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" value="{{ $dependent->id }}">
                        @if($errors->has('parent_id'))
                        <div class="invalid-feedback ml-3">{{ $errors->first('parent_id') }}</div>
                      @endif
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-4">
                        ...
                        class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" value="{{ $dependent->address }}">
                        <input type="text" id="locality" class="city" hidden name="city" value="{{ $dependent->city_name }}"/>
                  ...
                  <div class="col-md-2">
                    <div class="custom-control custom-radio custom-control-inline">
                      ...
                      {{ $dependent->gender == 0 ? 'checked':'' }}>
                      <label for="male" class="custom-control-label">Male</label>
                    </div>
                  </div>
                  <div class="col-md-2">
                    <div class="custom-control custom-radio custom-control-inline">
                      <input id="female" type="radio" value="1" name="gender" class="custom-control-input" {{ $dependent->gender == 1 ? 'checked':'' }}>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-1">
                    <div class="custom-control custom-radio custom-control-inline">
                      <input id="unmarried" type="radio" value="0" name="marital_status" class="custom-control-input" {{ $dependent->marital_status == 0 ? 'checked':'' }}>
                      <label for="unmarried" class="custom-control-label">Unmarried</label>
                    </div>
                  </div>
                  <div class="col-md-2">
                    <div class="custom-control custom-radio custom-control-inline">
                      <input id="married" type="radio" value="1" name="marital_status" class="custom-control-input" {{ $dependent->marital_status == 1 ? 'checked':'' }}>
                ...
                <div class="form-group row">
                <label class="col-md-2 form-control-label">Depends On</label>
                  <div class="col-md-4">
                    <select name="parent_id" class="form-control selectpicker" data-live-search="true">
                      @foreach($org_employees as $employee)
                        <option data-value="$employee->id" value="{{ $employee->id }}"
                            {{ ($employee->id == $dependent->parent_id) ? 'selected' : ''}}
                            >
                            {{ ($employee->name) }}
                ...
                <div class="form-group row">
                  <div class="col-md-10 ml-auto">
                    <button type="submit" class="btn btn-primary">Save Dependent Profile</button>
                  </div>
                </div>
            </form>
          </div>

            ...
            <div class="col-lg-12">
                <div class="card">
                  <div class="card-header">
                    <h6 class="text-uppercase mb-0">Employees Not Contacted 
                    </h6>
                  </div>
                      ...
                      <tbody>
                        @if($employees)
                            ...
                            <tr>
                              ...
                              <td>{{$c->phone}}</td>
                              <td>
                                {{ ($c->gender == 1)? "Female":"Male"}}
                              </td>
                              <td>
                                {{ (isset($c->last_contact_date))? $c->last_contact_date:""}}
                              </td>
                              <td>
                                {{ (isset($c->next_contact_date))? $c->next_contact_date:""}}
                              </td>
